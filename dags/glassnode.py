...
METRIC_FILTER: List[str] = [
    ...
    "futures_funding_rate_perpetual_v2",
...
SCALAR_ASSET_ALLOWLISTS: Dict[str, List[str]] = {
    ...
    "futures_funding_rate_perpetual_v2": ["btc", "eth", "sol", "aave", "uni", "hype", "pendle", "ethfi", "ldo", "tao", "aero", "sui", "bnb", "link", "ena", "mon", "zec", "sky", "morpho", "virtual"],
    ...
    "mvrv_z_score": ["btc", "eth", "sol", "aave", "pendle", "ethfi", "ldo", "uni", "giza"],
    "mvrv": TOP_TWO_ASSETS,
    "mvrv_median": TOP_TWO_ASSETS,
    "mvrv_less_155": TOP_TWO_ASSETS,
    "mvrv_more_155": TOP_TWO_ASSETS,
    "sopr": ["btc", "eth", "sol", "aave", "pendle", "ethfi", "ldo", "uni", "giza"],
    "sopr_adjusted": ["btc"],
    ...
    "percent_addresses_in_profit": ["btc", "eth", "sol", "aave", "pendle", "ethfi", "ldo", "uni", "giza"],
...
METRIC_CONFIGS: List[MetricConfig] = [
    ...
    _make_scalar_metric(
        "futures_funding_rate_perpetual_v2",
        "/v1/metrics/derivatives/futures_funding_rate_perpetual_v2",
        currency=False,
        allowed_assets=SCALAR_ASSET_ALLOWLISTS["futures_funding_rate_perpetual_v2"],
    ),
    _make_scalar_metric(
        "mvrv_z_score",
